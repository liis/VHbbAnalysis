...
#    "file:/hdfs/cms/store/user/liis/VHbb_patTuples/TTJets_SemiLeptMGDecays/PAT.edm_1_1_ABF.root"
    "file:/hdfs/cms/store/user/liis/VHbb_patTuples/TTJets_FullLeptMGDecays/PAT.edm_118_0_8JD.root"
...
#/pnfs/pi.infn.it/data/cms/store/user/tboccali/ZH_ZToNuNu_HToBB_M-120_8TeV-powheg-herwigpp/HBB_EDMNtupleV30_ProcV1_ZH_ZToNuNu_HToBB_M-120/14fe2b624ddea84f5c39709f51bf546f/"dcap:///pnfs/cms/WAX/11/store/user/degrutto//testMET2012/PAT.edm_51_1_ukR.root
    #'dcap://t3se01.psi.ch:22125//pnfs/psi.ch/cms/trivcat/store/user/nmohr/TTH_HToBB_M-110_8TeV-pythia6/TTH_HToBB_M_110_8TeV_pythia6_Tester/6a5d9bb3161446313514456198d10252/PAT.edm_35_1_2iA.root'
    ...
    #'/scratch/bianchi/PAT.edm_57_0_I2a.root'
    #'root://xrootd.ba.infn.it//store/user/arizzi/TTJets_FullLeptMGDecays_8TeV-madgraph/TTJets_FullLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v2_EDMNtuple_V42_ProcV1/9803889241b1fc304f795d3b3875632d/PAT.edm_57_0_I2a.root'
#    'root://xrootd.ba.infn.it//store/user/lpchbb/degrutto/T_t-channel_TuneZ2star_8TeV-powheg-tauolaSummer12_DR53X-PU_S10_START53_V7A-v1/degrutto/T_t-channel_TuneZ2star_8TeV-powheg-tauola/HBB_EDMNtupleV42/9803889241b1fc304f795d3b3875632d/PAT.edm_12_1_wYH.root'
    ...
    maxEvents   = cms.int32(20000),                             ## optional
    runMin  = cms.int32(-1),
    runMax  = cms.int32(-1),
    ...
    doAll = cms.bool(True), #keep all events
    doAllHad = cms.bool(False), #disable MET cut, veto events with leptons
